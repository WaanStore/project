...
echo -e " 🔶$bd Client Name       ${color1} •${color3}$bd WAAN VPN"
...
[${green}04${NC}]${color1} •${color3}$bd PANEL : VMESS & VLESS (${color2}menu-v2ray${color3})
[${green}05${NC}]${color1} •${color3}$bd PANEL : SSR & SS (${color2}menu-ssr-ss${color3})
[${green}06${NC}]${color1} •${color3}$bd PANEL : TROJAN GFW & GO (${color2}menu-trojan${color3})
[${green}07${NC}]${color1} •${color3}$bd CHANGE PORT TUNNEL (${color2}menu-port${color3})
[${green}08${NC}]${color1} •${color3}$bd CEK STATUS SERVICE (${color2}running${color3})
...
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[41;1;39m                     ⇱ WAAN OFFICIAL ⇲                       \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e  ""
